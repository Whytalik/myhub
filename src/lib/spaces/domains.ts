...
export const DOMAINS: Domain[] = [
  {
    ...
    spaces: [
      ...
      },
      {
        ...
        pages: [
          { href: "/life/planning/wizard", label: "Майстер планування", icon: Sparkles },
          { href: "/life/planning/kanban", label: "Картки & Канбан", icon: Kanban },
          { href: "/life/planning", label: "Збір думок (Inbox)", icon: Lightbulb },
          { href: "/life/planning/spheres", label: "Сфери життя", icon: LayoutGrid },
          { href: "/life/planning/mission", label: "Місія", icon: Compass },
          { href: "/life/planning/review", label: "Аналіз тижня", icon: ListChecks },
        ],
      },
    ],
  },
