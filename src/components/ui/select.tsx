...
const Select = React.forwardRef<HTMLSelectElement, SelectProps>(
  ({ className, children, variant = "default", ...props }, ref) => {
    ...
    const variants = {
      default: "border border-accent/70 bg-surface/50 hover:border-accent focus-visible:border-accent",
      inline: "border border-border/50 bg-raised h-auto py-0.5 px-2 hover:border-accent focus-visible:border-accent",
    };
