...
export const PRODUCTS: Record<string, Product> = {
  ...
  tortilla: tracked(
    "tortilla",
    "Тортилья пшенична",
    { kcal: 306, protein: 8, fat: 7, carbs: 50 },
    "grains",
    { gramsPerPiece: 60, basePrice: 90 },
  ),
  ...
  // Орієнтовні значення типового укр. питного підсолодженого йогурту (бренд
  // буде різний щоразу) — звірити з етикеткою конкретної баночки перед
  // закупівлею. Для "Передтрен" (Сет1/3/5). Брати ПОРЦІЙНІ баночки (~100 г),
  // не велику пляшку, інакше калорійність зростає в рази проти банана.
  yogurtSweetened: tracked(
    "yogurtSweetened",
    "Йогурт питний підсолоджений",
    { kcal: 84, protein: 3.4, fat: 2, carbs: 13.3 },
    "dairy",
  ...
  // Окремо від cottageCheese (9%) — саме 1%/знежирений творог критичний для
  // творожної піци (Сет5): звичайний 9% майже подвоює жир страви.
  cottageCheeseLowFat: tracked(
    "cottageCheeseLowFat",
    "Творог 1% (знежирений)",
    { kcal: 101, protein: 18, fat: 1.8, carbs: 3.3 },
    "dairy",
    { searchTerm: "творог 1%", basePrice: 90 },
  ),
  soySauce: tracked(
    "soySauce",
    "Соєвий соус",
