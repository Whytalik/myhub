...
const proteinIngredients = [
  "Куряче стегно або філе — 1.21 кг",
  "Куряче філе — 1.1 кг",
  "Курячі серця — 600 г",
...
export function MealPrep() {
  const prepTable = [
    { name: "Куряче стегно або філе (шашлики — Пн)", qty: "530 г", marinade: "Йогуртово-лимонний" },
  ...
  const algorithm = [
    {
      ...
      steps: [
        ...
        "Нарізка: куряче стегно для шашликів (530 г) нарізати порційними шматочками розміром 2–3 см.",
        "Миска 1 (Йогуртово-лимонний): змішати грецький йогурт 150 г, сік ½ лимона + подрібнену цедру, 2 вичавлені зубчики часнику, 1 ч.л. паприки, ½ ч.л. прованських трав, 1 ст.л. оливкової олії, сіль та чорний перець. Додати куряче стегно (530 г) та перемішати.",
