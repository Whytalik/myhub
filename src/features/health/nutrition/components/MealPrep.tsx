  ...
  const twoDayAlgorithm = [
    ...
    },
    {
      ...
      steps: [
        ...
        "Виняток — Сет 3: день 1 і день 2 це дві різні страви (запечена скумбрія → тунцевий салат), кожна своя, без розігріву однієї в іншу. Виняток — Сет 6 (паста з куркою): свіжого салату там немає, і на день 2 просто розігрівається вся страва цілком.",
      ],
    },
    {
