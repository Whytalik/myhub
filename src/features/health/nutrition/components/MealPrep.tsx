...
export function MealPrep() {
  ...
  const algorithm = [
    ...
    {
      title: "Блок 2 — Поки м'ясо маринується (~20 хв активно)",
      steps: [
        "Корейська морква: натерти моркву → посолити → залишити на 10 хв.",
        "Поки морква стоїть: сирники — розім'яти творог → замісити тісто → сформувати 10 шт.",
        "Повернутись до моркви: віджати → влити розігріту олію → спеції, часник, оцет → в холодильник на ніч.",
        "Сирники: сформувати 10 заготовок → на дошку в морозилку (смажити свіжими перед прийомом).",
      ],
    },
    {
      title: "Фінал",
