...
export const SHOPPING_LIST: ShoppingCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        qualifier: "свіжа",
        qty: "1 шт (~1 кг)",
        note: "Сет3, день 1 — готується в мілпрепі; сет тепер на 2 дні, риби більше, ніж коли це була лише половина дня. 1 ціла скумбрія ~1кг вже покриває потрібні ~650г",
        price: 150,
        buyDay: "sun",
      },
    ],
