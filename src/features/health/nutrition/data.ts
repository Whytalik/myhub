  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: "fruits-apple-sun",
        food: "apple",
        computedQty: { food: "apple", sets: [{ set: "set1" }] },
        note: "Сет1 (десерт до прийомів)",
        price: 45,
        buyDay: "sun",
      },
      {
      ...
      {
        id: "fruits-orange-sun",
        food: "orange",
        computedQty: { food: "orange", sets: [{ set: "set2" }] },
      ...
      },
      {
        ...
        food: "apricot",
        computedQty: { food: "apricot", sets: [{ set: "set3" }, { set: "set7" }] },
        note: "Сет3, Сет7 (десерт до прийомів)",
        price: 90,
        buyDay: "sun",
      },
      {
