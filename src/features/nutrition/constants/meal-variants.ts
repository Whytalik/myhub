...
export const MEAL_VARIANTS: Record<string, MealVariant[]> = {
  ...
  "Обід": [
    { name: "Зібраний Боул", icon: "🥣", products: [
      ...
      { name: "Куряче філе", alts: ["Смажений курячий фарш", "Курячі серця"], youGrams: 150, herGrams: 100 },
    ...
    { name: "Зігріваючий Суп", icon: "🍲", products: [
      { name: "Червона сочевиця", youGrams: 50, herGrams: 80 },
  ...
  "Вечеря": [
    { name: "Овочеве Рагу", icon: "🍛", products: [
      { name: "Куряче філе", alts: ["Яловичий фарш"], youGrams: 150, herGrams: 100 },
      { name: "Картопля", youGrams: 100, herGrams: 150 },
      { name: "Морква", youGrams: 60, herGrams: 80 },
      { name: "Кабачок", youGrams: 100, herGrams: 120 },
      { name: "Перець", youGrams: 50, herGrams: 80 },
    ...
    { name: "Риба + Зелень", icon: "🥦", products: [
      ...
      { name: "Грецький йогурт", youGrams: 15, herGrams: 20 },
    ]},
