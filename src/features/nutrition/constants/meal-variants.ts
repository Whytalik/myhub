...
export const MEAL_VARIANTS: Record<string, MealVariant[]> = {
  "Передтрен": [
    ...
    { name: "Енергія",  icon: "🍌", products: [
      { name: "Банан стиглий", youGrams: 120, herGrams: 120 },
      { name: "Теплий чай", youGrams: 0, herGrams: 0 },
    ]},
    { name: "Баланс",   icon: "🥨", products: [
      { name: "Солона соломка", youGrams: 40, herGrams: 40 },
      { name: "Теплий чай", youGrams: 0, herGrams: 0 },
    ]},
  ...
  "Сніданок": [
    { name: "Сирні панкейки", icon: "🥞", products: [
      ...
      { name: "ЦЗ Борошно", youGrams: 20, herGrams: 30 },
      { name: "Яблуко", alts: ["Груша", "Вишня замор.", "Чорниця замор."], youGrams: 80, herGrams: 100 },
      { name: "Мед", youGrams: 5, herGrams: 5 },
    ...
    { name: "Білковий омлет", icon: "🍳", products: [
      ...
      { name: "Куряче філе", youGrams: 100, herGrams: 80 },
      { name: "Помідор", alts: ["Мікс овочей"], youGrams: 200, herGrams: 150 },
      { name: "ЦЗ Хліб", youGrams: 30, herGrams: 30 },
      { name: "Насіння льону", youGrams: 10, herGrams: 10 },
    ...
    { name: "Тости з тунцем", icon: "🐟", products: [
      ...
      { name: "Огірок", alts: ["Зелена цибуля"], youGrams: 50, herGrams: 80 },
      { name: "Насіння льону", youGrams: 10, herGrams: 10 },
    ...
    { name: "Breakfast Wrap", icon: "🌯", products: [
      ...
      { name: "Айсберг", alts: ["Огірок"], youGrams: 80, herGrams: 100 },
      { name: "Насіння льону", youGrams: 10, herGrams: 10 },
      { name: "Помідор", youGrams: 50, herGrams: 80 },
      { name: "Цибуля червона", youGrams: 15, herGrams: 20 },
      { name: "Лимонний сік", youGrams: 0, herGrams: 0 },
    ]},
  ],
  "Обід": [
    { name: "Зібраний Боул", icon: "🥣", products: [
      { name: "Гречка", alts: ["Рис", "Булгур"], youGrams: 150, herGrams: 250 },
      { name: "Куряче філе", alts: ["Тунець консерва"], youGrams: 150, herGrams: 100 },
      { name: "Морква", youGrams: 80, herGrams: 0 },
      ...
      { name: "Олія оливкова", alts: ["Арахіс смажений"], youGrams: 5, herGrams: 5 },
      { name: "Соус для боулу", youGrams: 0, herGrams: 0 },
    ]},
    { name: "Паста-конструктор", icon: "🍝", products: [
      { name: "Макарони ТЗ", youGrams: 150, herGrams: 300 },
      { name: "Куряче філе", alts: ["Яловичий фарш"], youGrams: 150, herGrams: 100 },
      { name: "Томатна пасата", youGrams: 100, herGrams: 150 },
      { name: "Цибуля", youGrams: 30, herGrams: 40 },
      { name: "Морква", youGrams: 50, herGrams: 60 },
      { name: "Твердий сир", youGrams: 10, herGrams: 20 },
      { name: "Томатна заправка", youGrams: 0, herGrams: 0 },
    ]},
    { name: "Зігріваючий Суп", icon: "🍲", products: [
      { name: "Червона сочевиця", alts: ["Нут"], youGrams: 50, herGrams: 80 },
      { name: "Куряче філе", youGrams: 100, herGrams: 50 },
      { name: "Картопля", youGrams: 100, herGrams: 150 },
      { name: "Морква", youGrams: 50, herGrams: 60 },
      { name: "Цибуля", youGrams: 30, herGrams: 40 },
      { name: "Петрушка", alts: ["Кріп"], youGrams: 5, herGrams: 5 },
    ...
    { name: "Печена тарілка", icon: "🐟", products: [
      ...
      { name: "Хек", alts: ["Тилапія", "Куряче стегно"], youGrams: 150, herGrams: 100 },
      { name: "Морква по-корейськи", alts: ["Капуста"], youGrams: 80, herGrams: 100 },
      { name: "Лимонно-трав'яний", youGrams: 0, herGrams: 0 },
      { name: "Ткемалі готовий", youGrams: 0, herGrams: 0 },
    ]},
  ],
  "Вечеря": [
    { name: "Овочеве Рагу", icon: "🍛", products: [
      { name: "Куряче філе", alts: ["Яловичий фарш"], youGrams: 150, herGrams: 100 },
      { name: "Кабачок", alts: ["Морква", "Перець"], youGrams: 120, herGrams: 80 },
      { name: "Квасоля", alts: ["Нут"], youGrams: 50, herGrams: 100 },
      { name: "Томатна паста", youGrams: 10, herGrams: 10 },
      { name: "Пряний томатний", youGrams: 0, herGrams: 0 },
    ]},
    { name: "Солодкий Сир", icon: "🍓", products: [
      { name: "Сир кисломолочний", youGrams: 200, herGrams: 200 },
      { name: "Яблуко", alts: ["Груша", "Вишня замор.", "Чорниця замор."], youGrams: 80, herGrams: 100 },
      { name: "Арахіс", alts: ["Насіння льону"], youGrams: 10, herGrams: 20 },
      { name: "Мед", youGrams: 5, herGrams: 5 },
      { name: "Медово-корична заправка", youGrams: 0, herGrams: 0 },
    ]},
    { name: "Риба + Зелень", icon: "🥦", products: [
      { name: "Хек", alts: ["Тилапія", "Мінтай"], youGrams: 150, herGrams: 100 },
      { name: "Гречка", alts: ["Рис"], youGrams: 100, herGrams: 150 },
      { name: "Броколі зам.", alts: ["Цвітна капуста зам."], youGrams: 100, herGrams: 80 },
      { name: "Часниково-кропова заправка", youGrams: 0, herGrams: 0 },
      { name: "Хрін тертий", youGrams: 0, herGrams: 0 },
    ]},
    { name: "Протеїновий Салат", icon: "🥗", products: [
      { name: "Тунець у вл. соку", alts: ["Куряче філе", "Яйця"], youGrams: 150, herGrams: 100 },
      { name: "Айсберг", alts: ["Пекінська капуста"], youGrams: 200, herGrams: 200 },
      { name: "Огірок", alts: ["Помідор"], youGrams: 100, herGrams: 150 },
