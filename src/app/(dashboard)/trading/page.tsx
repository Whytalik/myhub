  ...
  return (
    ...
    >
      <div className="bg-surface/30 border border-dashed border-border/40 p-24 rounded-2xl text-center">
        ...
        <h3 className="text-body font-black uppercase tracking-tight text-muted mb-4">Trading Space Offline</h3>
        <p className="text-secondary text-body max-w-md mx-auto mb-8">
        ...
        <div className="bg-accent/10 border border-accent/20 px-6 py-3 rounded-lg inline-flex items-center gap-3">
          ...
          <span className="text-note font-mono text-accent uppercase tracking-widest font-bold">Awaiting Market Integration</span>
        </div>
      </div>
    </SpaceLanding>
  );
