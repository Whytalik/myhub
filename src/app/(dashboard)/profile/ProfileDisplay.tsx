  ...
  return (
    <div className="flex flex-col gap-10 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      <div>
        ...
        <p className="text-secondary text-sm mt-1">Your identity across the hub.</p>
      </div>
      ...
      <div className="flex flex-col gap-6 max-w-2xl">
        <div className="bg-surface border border-border rounded-2xl p-8 flex flex-col gap-6">
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              ...
              <div className="w-full bg-raised border border-border rounded-xl pl-11 pr-4 py-3 text-[14px] text-text">
                {user.name || "Not set"}
              </div>
            </div>
          </div>
        ...
        <div className="bg-surface/40 border border-border/40 rounded-2xl p-8 flex items-center gap-6">
          ...
          <div>
             <p className="text-[10px] font-mono text-muted uppercase tracking-widest">Member since</p>
